package com.batorus.apisfortreesdatastructures.model.AVL;
...
public class AVLTree<E extends Comparable<E>> extends BST<E> {
     ...
     */
    public AVLTree(List<E> elements) {
        super(elements);
    }
    ...
    public List<AVLTreeNode<E>> findElement(E e) {

        ArrayList<TreeNode<E>> path = path(e);
        ArrayList<AVLTreeNode<E>> avlpath = new ArrayList<>();
        for(TreeNode<E> el : path) avlpath.add((AVLTreeNode<E>)el);
    ...
    public boolean delete(E element) {
        ...
        if (current.left == null) {
            ...
            if (parentOfRightMost.right == rightMost)
                ...
                //pointerii nu s-au miscat, asa ca parentOfRightMost o sa pointeze acum spre left child of rightMost
